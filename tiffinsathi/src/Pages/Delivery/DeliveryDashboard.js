...
const DeliveryDashboard = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const todayOrders = Array.isArray(todayResponse.data)
        ? todayResponse.data
        : [];
  ...
  const getStatusInfo = (status) => {
    ...
    return (
      statusMap[status] || { label: status, color: "gray", step: 0, action: "" }
    );
  };
        ...
        <div className="flex justify-between relative">
          ...
          {steps.map((step) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-col items-center ${isCompleted ? "opacity-100" : "opacity-60"}`}
                >
                  <div
              ...
              {deliveryProfile && (
                <div className="flex items-center gap-2 mt-2 text-sm text-gray-700">
                  ...
                  <span>
                    ...
                    {deliveryProfile.vehicleInfo || "Delivery Partner"}
                  </span>
                </div>
              )}
            </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                {order.deliveryDate} •{" "}
                                {order.preferredDeliveryTime || "Anytime"}
                              </p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${
                                getStatusInfo(order.status).color === "blue"
                          ...
                          <div className="flex items-center gap-2">
                            {order.customer?.phoneNumber && (
                              <>
                                <button
                                  onClick={() =>
                                    callCustomer(order.customer.phoneNumber)
                                  }
    ...
    <div className="border border-gray-200 rounded-xl p-4 bg-white hover:shadow-md transition-shadow">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <span
            className={`px-2 py-1 rounded-full text-xs font-medium ${
              getStatusInfo(order.status).color === "green"
                ? "bg-green-100 text-green-800"
