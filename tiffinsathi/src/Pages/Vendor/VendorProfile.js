...
const VendorProfile = () => {
  ...
  const validatePasswordForm = () => {
    ...
    if (!isValid) {
      showToast("Password doesn't meet the requirements", "error");
      return false;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 py-4 md:py-8">
      <ToastContainer />
      
      <div className="max-w-6xl mx-auto px-3 sm:px-4">
        {/* Header */}
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-4 sm:mb-6 border border-gray-100">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-2 px-3 sm:px-4 rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all shadow-sm text-sm sm:text-base"
              >
              ...
              <button
                ...
                disabled={saving}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-green-700 text-white py-2 px-3 sm:px-4 rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-sm disabled:opacity-50 text-sm sm:text-base"
              >
                {isEditing ? (
                  <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 border border-gray-100">
              <div className="flex flex-col items-center">
                <div className="relative mb-4">
                  <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center overflow-hidden border-4 border-white shadow-lg">
                    {vendor.profilePicture || profileImage ? (
                      ...
                      <Building className="w-12 h-12 sm:w-16 sm:h-16 text-green-400" />
                    )}
                  </div>
                  {isEditing && (
                    <label className="absolute bottom-0 right-0 bg-gradient-to-r from-green-600 to-green-700 text-white p-1.5 sm:p-2 rounded-full cursor-pointer hover:from-green-700 hover:to-green-800 transition-all shadow-lg">
              ...
              <div className="mt-6 space-y-2 sm:space-y-3">
                <div className="flex items-center gap-2 text-gray-600 p-2 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200">
            ...
            {/* Business Stats */}
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mt-4 sm:mt-6 border border-gray-100">
          ...
          <div className="lg:col-span-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors text-sm sm:text-base"
                    />
                  ) : (
                    <div className="flex items-center gap-2 text-gray-900 p-3 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 text-sm sm:text-base">
                      <User className="w-4 h-4" />
                      {vendor.ownerName}
                    </div>
                  )}
                ...
                <div className="md:col-span-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-start gap-2 text-gray-900 p-3 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 text-sm sm:text-base">
                ...
                <div className="md:col-span-2">
                  ...
                  {isEditing ? (
                    ...
                    <div className="text-gray-900 p-3 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 text-sm sm:text-base">
            ...
            <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mt-4 sm:mt-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg bg-gradient-to-r from-gray-50 to-gray-100">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4 p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg border border-green-200">
              <p className="text-sm font-medium text-green-800 mb-2">Password Requirements:</p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-3 py-2 border ${passwordErrors.length > 0 && passwordData.newPassword ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 pr-10`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-3 py-2 border ${passwordData.confirmPassword && passwordData.newPassword !== passwordData.confirmPassword ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 pr-10`}
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mt-6">
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg transition text-sm sm:text-base ${passwordErrors.length > 0 || passwordData.newPassword !== passwordData.confirmPassword
